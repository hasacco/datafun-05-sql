"""app_candy_duckdb_hasacco.py - Project script.
...
Paths (relative to repo root):
   SQL:  sql/duckdb/*.sql
   CSV:  data/raw/candy/targets.csv
   CSV:  data/raw/candy/products.csv
   CSV:  data/raw/candy/sales.csv
   DB:   artifacts/duckdb/candydb.duckdb
...
CANDY_TARGETS_CSV: Final[Path] = DATA_RAW_DIR / "targets.csv"
CANDY_PRODUCTS_CSV: Final[Path] = DATA_RAW_DIR / "products.csv"
CANDY_SALES_CSV: Final[Path] = DATA_RAW_DIR / "sales.csv"
DB_PATH: Final[Path] = ARTIFACTS_DIR / "candydb.duckdb"
